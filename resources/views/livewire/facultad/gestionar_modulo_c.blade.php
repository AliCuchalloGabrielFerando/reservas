<div  x-data="{open: false}">
    <div class=" flex justify-center">
        <h1 class="text-center text-3xl dark:text-white mt-10 border-1 border-blue-100">Gestión de Módulos</h1>
    </div>
        ...
        <div class="p-8 flex flex-wrap items-center justify-center">
            ...
            <div class="flex-shrink-0 mx-6 relative overflow-hidden bg-indigo-900 dark:bg-blue-300 rounded-lg max-w-xs shadow-lg">
                ...
                <div class="relative px-6 pb-6 mt-6">
                    <span class="text-white dark:text-black block font-semibold text-xl">Módulo {{$modulo->nro}}</span>
                    <br>
                        <div class="flex justify-between">
                        <button wire:click="irAulas({{$modulo->id}})" type="button" class="text-white dark:text-black inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Ver Aulas
                        </button>
